...
{
	return {
		"name":			"SimpleQRScanner",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
...
AddAction(0, af_none, "Decode", "QR Code", "Decode QR Code", "Decode QR Code.", "qrDecode");
...
AddExpression(0, ef_return_string, "Decoded QR Code", "QR Code", "decodedQRCode", "Return the decoded QR Code.");
